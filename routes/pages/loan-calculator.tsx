  ...
  useEffect(() => {
    ...
    applySEO({
      ...
      jsonLd: [
        ...
        { "@context": "https://schema.org", "@type": "FAQPage", mainEntity: EDUCATION[locale].faqs.map((item: {q: string; a: string}) => ({ "@type": "Question", name: item.q, acceptedAnswer: { "@type": "Answer", text: item.a } })) },
      ],
    });
  }, [locale]);
