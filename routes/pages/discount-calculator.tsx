...
const LANGUAGES = {
  en: { name: "English", title: "Discount Calculator", subtitle: "Calculate sale price after discount, or find the discount percent from original and sale price.", searchLabel: "Search tools", searchPlaceholder: "Try: percent, tip, loan, currency", reserveAd: "Google Ads space reserved", reserveAdSub: "Drop your AdSense code here later.", mode1: "Find sale price", mode2: "Find discount %", originalLabel: "Original price", discountLabel: "Discount (%)", saleLabel: "Sale price", result: "You pay", saved: "You save", calculate: "Calculate" },
  "zh-hk": { name: "繁體中文", title: "折扣計算器", subtitle: "計折扣後售價，或者從原價同售價搵出折扣百分比。", searchLabel: "搜尋工具", searchPlaceholder: "例如：百分比、小費、貸款、貨幣", reserveAd: "預留 Google 廣告位", reserveAdSub: "之後可直接放 AdSense 程式碼。", mode1: "計折後價", mode2: "計折扣%", originalLabel: "原價", discountLabel: "折扣 (%)", saleLabel: "折後價", result: "你要畀", saved: "你慳咗", calculate: "計算" },
  "zh-cn": { name: "简体中文", title: "折扣计算器", subtitle: "计算折扣后价格，或从原价和售价找出折扣百分比。", searchLabel: "搜索工具", searchPlaceholder: "例如：百分比、小费、贷款、货币", reserveAd: "预留 Google 广告位", reserveAdSub: "之后可直接放 AdSense 代码。", mode1: "计算折后价", mode2: "计算折扣%", originalLabel: "原价", discountLabel: "折扣 (%)", saleLabel: "折后价", result: "你需要付", saved: "你省了", calculate: "计算" },
  es: { name: "Español", title: "Calculadora de descuentos", subtitle: "Calcula el precio de venta después del descuento, o encuentra el porcentaje de descuento a partir del precio original y el de venta.", searchLabel: "Buscar herramientas", searchPlaceholder: "Prueba: percent, tip, loan", reserveAd: "Espacio reservado para Google Ads", reserveAdSub: "Puedes insertar AdSense aquí más adelante.", mode1: "Encontrar precio final", mode2: "Encontrar % descuento", originalLabel: "Precio original", discountLabel: "Descuento (%)", saleLabel: "Precio final", result: "Pagas", saved: "Ahorras", calculate: "Calcular" },
};
