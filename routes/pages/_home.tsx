...
import { ArrowLeftRight, ArrowRight, BadgeDollarSign, Bone, BookOpen, Building2, CalendarDays, CalendarRange, Calculator, Cat, Clock, Dog, DollarSign, FileType, Flame, Flower2, Globe2, HeartPulse, Home, Link2, PartyPopper, Percent, RotateCw, Scale, Search, Sparkles, Grid3X3 } from "lucide-react";
...
const TOOLS: Array<{
  ...
  { category: "people", href: "/famous-birthdays", icon: PartyPopper, title: { en: "Famous Birthdays", "zh-hk": "名人生日", "zh-cn": "名人生日", es: "Cumpleaños de famosos" }, description: { en: "Birthdays, current ages, and star signs of notable people.", "zh-hk": "名人嘅生日、目前年齡同星座。", "zh-cn": "名人的生日、目前年龄和星座。", es: "Cumpleaños, edad actual y signos de personas notables." } },
...
const GROUPS: Array<{ id: string; title: Record<LocaleKey, string>; items: string[] }> = [
  ...
  { id: "people", title: { en: "People", "zh-hk": "人物", "zh-cn": "人物", es: "Personas" }, items: ["/famous-birthdays"] },
